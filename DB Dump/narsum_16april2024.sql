...
-- Dumping data for table narsum.bagian: ~0 rows (approximately)
...
-- Dumping data for table narsum.biro: ~2 rows (approximately)
...
-- Dumping data for table narsum.kegiatan: ~2 rows (approximately)
INSERT INTO `kegiatan` (`id_kegiatan`, `kode_kegiatan`, `nama_kegiatan`, `id_mak`, `tanggal`, `tempat`, `file_undangan`, `file_laporankegiatan`, `created_at`, `updated_at`) VALUES
	(17, 'rMX5N0hj3W', 'Test', 2, '2024-04-15', 'Pondok Ranji', 'Invoice-4152722_1713161585.pdf', 'laporan-monitoring-capaian_1713161585.pdf', '2024-04-15 06:12:40', '2024-04-15 06:39:05'),
	(18, 'v0H1N5O5j9', 'OKe', 2, '2024-04-16', 'Yes', '', NULL, '2024-04-15 07:10:20', NULL),
...
-- Dumping data for table narsum.kegiatan_detail: ~5 rows (approximately)
INSERT INTO `kegiatan_detail` (`id_kegiatandetail`, `id_narasumber`, `kode_kegiatan`, `jumlah_jam`, `honor_satujam`, `jumlahhonor`, `pph`, `potongan_pph`, `jumlah_bayar`, `file_surattugas`, `is_sppd`, `nominal_sppd`, `file_kwitansi`, `is_transfer`, `no_spm`, `tanggal_transfer`, `file_transfer`, `is_verified`, `created_at`, `updated_at`) VALUES
	(16, 1, 'rMX5N0hj3W', 1, 1000000, '1000000', 15, 150000, 850000, NULL, 'no', 0, NULL, 'no', NULL, NULL, NULL, 'no', '2024-04-14 23:15:33', '2024-04-14 23:23:36'),
	(17, 2, 'rMX5N0hj3W', 2, 900000, '1800000', 5, 90000, 1710000, NULL, 'yes', 1000000, NULL, 'yes', '022/SPM/2024', '2024-04-16', 'WhatsApp Image 2024-02-27 at 09.55.32_1713163846.jpeg', 'no', '2024-04-14 23:24:48', '2024-04-14 23:50:46'),
	(18, 3, 'v0H1N5O5j9', 1, 1400000, '1400000', 15, 210000, 1190000, NULL, 'no', 0, NULL, 'yes', '88', '2024-04-17', NULL, 'no', '2024-04-15 00:10:29', '2024-04-15 00:10:53'),
	(19, 1, 'ILp2xla4Ar', 1, 1000000, '1000000', 15, 150000, 850000, 'FORM-ABSEN_1713165425.docx', 'no', 0, 'FORM-ABSEN_1713165425.docx', 'yes', '022/SPM/2024', '2024-04-16', 'manohara-hotel_1713165446.PNG', 'no', '2024-04-15 00:17:05', '2024-04-15 00:17:26'),
	(20, 2, 'ILp2xla4Ar', 1, 900000, '900000', 5, 45000, 855000, NULL, 'yes', 2000000, NULL, 'yes', '88', '2024-04-17', 'manohara-hotel_1713165510.PNG', 'no', '2024-04-15 00:18:06', '2024-04-15 00:18:30');
...
INSERT INTO `users` (`id`, `name`, `username`, `email`, `email_verified_at`, `password`, `remember_token`, `id_user_level`, `is_active`, `id_bagian`, `created_at`, `updated_at`) VALUES
	(1, 'Administrator', 'admin', 'admin@admin.com', NULL, '$2y$10$FlPQGDjSv.1eVQ53n8.JPeHPLSvY30PRvp.W0eBQxFnNB8A8Z.Wua', NULL, 1, 'yes', NULL, '2024-03-18 21:21:07', '2024-03-18 21:21:07'),
	(3, 'Operator', 'operator', 'admin1@admin.com', NULL, '$2y$10$FlPQGDjSv.1eVQ53n8.JPeHPLSvY30PRvp.W0eBQxFnNB8A8Z.Wua', NULL, 2, 'yes', NULL, '2024-04-15 07:47:18', NULL),
