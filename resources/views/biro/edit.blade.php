    ...
    <form class="form-horizontal" id="formulir" name="formulir" method="post" enctype="multipart/form-data" novalidate="novalidate">
        ...
        <div class="card-body">
          <div class="form-group row">
            <label for="mataanggaran" class="col-sm-3 col-form-label">Nama biro</label>
            <div class="col-sm-9">
              <input type="hidden" class="form-control" value="{{ $biro->id_biro }}" id="id_biro" name="id_biro">
              <input type="text" class="form-control" value="{{ $biro->nama_biro }}" id="nama_biro" name="nama_biro">
            </div>
          </div>
          <div class="form-group row">
            <label for="mataanggaran" class="col-sm-3 col-form-label">Nama pejabat</label>
            <div class="col-sm-7">
              <input type="input" class="form-control" value="{{ $biro->nama_pejabat }}" id="nama_pejabat" name="nama_pejabat">
            </div>
          </div>
          <div class="form-group row">
            <label for="mataanggaran" class="col-sm-3 col-form-label">NIP</label>
            <div class="col-sm-5">
              <input type="input" class="form-control" value="{{ $biro->nip }}" id="nip" name="nip">
            </div>
          </div>
        </div>
