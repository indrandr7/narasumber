...
<div class="content-wrapper">
                            ...
                            <table id="tabeldata" class="table table-bordered table-hover table-striped" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="ratatengah warnabg-gray vertikaltengah" width="30%">Nama Biro</th>
                                        <th class="ratatengah warnabg-gray vertikaltengah" width="30%">Pejabat</th>
                                        <th class="ratatengah warnabg-gray vertikaltengah" width="25%">NIP</th>
  ...
  <script type="text/javascript">
    ...
    function showFormAdd(){
        $('#modalku').modal('show').find('#modalku_content').load("{{ url('/biro/add') }}");
    }

    function showFormEdit(id){
        $('#modalku').modal('show').find('#modalku_content').load("{{ url('/biro/edit') }}?id="+id);
    }
