...
<div class="content-wrapper">
                            ...
                            <table id="tabeldata" class="table table-bordered table-hover table-striped" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="ratatengah warnabg-gray vertikaltengah" width="30%">Bagian</th>
                                        <th class="ratatengah warnabg-gray vertikaltengah" width="15%">Kode MAK</th>
                                        <th class="ratatengah warnabg-gray vertikaltengah" width="40%">Nama Kegiatan</th>
  ...
  <script type="text/javascript">
    ...
    function showFormAdd(){
        $('#modalku').modal('show').find('#modalku_content').load("{{ url('/mataanggaran/add') }}");
    }

    function showFormEdit(id){
        $('#modalku').modal('show').find('#modalku_content').load("{{ url('/mataanggaran/edit') }}?id="+id);
    }
    ...
    $(function (){
        ...
        var table = $('#tabeldata').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ url('/mataanggaran/getlist') }}",
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                {data: 'nama_bagian', name: 'nama_bagian'},
                {data: 'kodemak', name: 'kodemak'},
