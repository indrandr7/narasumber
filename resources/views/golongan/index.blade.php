...
<div class="content-wrapper">
                            ...
                            <table id="tabeldata" class="table table-bordered table-hover table-striped" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="ratatengah warnabg-gray vertikaltengah" width="55%">Golongan</th>
                                        <th class="ratatengah warnabg-gray vertikaltengah" width="30%">PPH</th>
  ...
  <script type="text/javascript">
    ...
    function showFormAdd(){
        $('#modalku').modal('show').find('#modalku_content').load("{{ url('/golongan/add') }}");
    }

    function showFormEdit(id){
        $('#modalku').modal('show').find('#modalku_content').load("{{ url('/golongan/edit') }}?id="+id);
    }
