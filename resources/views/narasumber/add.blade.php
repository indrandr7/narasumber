    ...
    <form class="form-horizontal" id="formulirNarsum" name="formulirNarsum" method="post" enctype="multipart/form-data" novalidate="novalidate">
        ...
        <div class="card-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-5">
              <input type="input" class="form-control" id="nomor_identitas" name="nomor_identitas">
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <input type="input" class="form-control" id="jabatan" name="jabatan">
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="input" class="form-control" id="unit_kerja" name="unit_kerja">
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-4">
                <input type="input" class="form-control" id="nomor_telpon" name="nomor_telpon">
            </div>
          </div>
          <div class="form-group row">
            <label for="mataanggaran" class="col-sm-3 col-form-label">Email</label>
            <div class="col-sm-5">
              <input type="input" class="form-control" id="email" name="email" value=""> 
            </div>
          </div>
          <div class="form-group row">
            <label for="potongan" class="col-sm-3 col-form-label">Nama bank</label>
            <div class="col-sm-5">
                <input type="input" class="form-control" id="nama_bank" name="nama_bank">
            </div>
          </div>
          <div class="form-group row">
            <label for="jumlahdibayar" class="col-sm-3 col-form-label">Nomor rekening</label>
            <div class="col-sm-6">
                <input type="input" class="form-control" id="nomor_rekening" name="nomor_rekening">
            </div>
          </div>
          <div class="form-group row">
            <label for="jumlahdibayar" class="col-sm-3 col-form-label">Nama di rekening</label>
            <div class="col-sm-6">
                <input type="input" class="form-control" id="nama_rekening" name="nama_rekening">
            </div>
          </div>
          <div class="form-group row">
            <label for="jumlahdibayar" class="col-sm-3 col-form-label">Nomor NPWP</label>
            <div class="col-sm-5">
                <input type="input" class="form-control" id="nomor_npwp" name="nomor_npwp">
            </div>
          </div>
          <div class="form-group row">
