    ...
    <form class="form-horizontal" id="formulir" name="formulir" method="post" enctype="multipart/form-data" novalidate="novalidate">
        ...
        <div class="card-body">
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="hidden" class="form-control" value="{{ $bagian->id_bagian }}" id="id_bagian" name="id_bagian">
              <input type="text" class="form-control" value="{{ $bagian->nama_bagian }}" id="nama_bagian" name="nama_bagian">
            </div>
          </div>
          <div class="form-group row">
            ...
            <div class="col-sm-3">
              <select class="form-control" id="id_biro" name="id_biro" style="width: 250%;">
                @foreach ($biro as $br)
                  @if ($br->id_biro == $bagian->id_biro)
                  <option value="{{ $br->id_biro }}" selected>{{ $br->nama_biro }}</option>
                  @else
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-7">
              <input type="input" class="form-control" value="{{ $bagian->nama_pejabat }}" id="nama_pejabat" name="nama_pejabat">
            </div>
          </div>
          <div class="form-group row">
            <label for="mataanggaran" class="col-sm-3 col-form-label">NIP</label>
            <div class="col-sm-5">
              <input type="input" class="form-control" value="{{ $bagian->nip }}" id="nip" name="nip">
            </div>
          </div>
        </div>
