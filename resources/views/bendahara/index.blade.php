...
<div class="content-wrapper">
                            ...
                            <table id="tabeldata" class="table table-bordered table-hover table-striped" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="ratatengah warnabg-gray vertikaltengah" width="30%">Nama Lengkap</th>
                                        <th class="ratatengah warnabg-gray vertikaltengah" width="30%">NIP</th>
                                        <th class="ratatengah warnabg-gray vertikaltengah" width="25%">Tahun</th>
  ...
  <script type="text/javascript">
    ...
    function showFormAdd(){
        $('#modalku').modal('show').find('#modalku_content').load("{{ url('/bendahara/add') }}");
    }

    function showFormEdit(id){
        $('#modalku').modal('show').find('#modalku_content').load("{{ url('/bendahara/edit') }}?id="+id);
    }
